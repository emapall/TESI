...
Given a variation and its relative trajectory, there is another important quantity, which is the corresponding \grass{infinitesimal variation}. This is yet another map defined with the following limit
\equaz{
...
%\subsection{Properties of the adjoint repsonse }
%What this theorem says is that equations \eqref{adjoint-equation} and \eqref{adjoint-hamiltonian} are equivalent.
%
%\paragraph[prop 4.4]{Hamilton's and adjoint equations}
%\begin{teo}
%	Given a control system \controlSystem, an admissible control $\mu:I\fd U$, and two maps $\xi:I\fd\chi;$\space$\lambda:I\fd\R^n$, those two statements are equivalent: \lista{
...
%\label{4-4}
%\end{teo}
%This theorem is demonstrated simply by differentiating the given quantities, and by using the properties of the dot product. 
%
%
